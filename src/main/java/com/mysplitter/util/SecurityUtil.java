...
public class SecurityUtil {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println();
        System.out.println("Encryption tool comes from \"com.alibaba.druid:1.1.9\". The author further modifies on this basis.");
    ...
    public static String encrypt(byte[] keyBytes, String plainText)
        ...
        try {
            ...
            RSAPublicKeySpec publicKeySpec = new RSAPublicKeySpec(rsaPrivateKey.getModulus(), rsaPrivateKey
                    .getPrivateExponent());
